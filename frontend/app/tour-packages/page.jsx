...
function TourPackagesContent() {
  ...
  // Filter & Sort States (Initial value populated from URL query params)
        ...
        <div className="lg:col-span-3 bg-white border border-border-soft rounded-card shadow-sm p-6 flex flex-col gap-6 text-left h-fit">
          <div className="flex items-center justify-between border-b border-border-soft pb-4">
            ...
            <button
              ...
              className="text-[10px] uppercase font-bold tracking-wider text-accent-gold hover:text-primary-teal transition-colors"
            >
              Reset All
            </button>
          </div>
          ...
          {isLoading ? (
            ...
            <div className="bg-white border border-border-soft rounded-card p-12 text-center flex flex-col items-center gap-4">
              ...
              <p className="text-text-muted text-sm max-w-sm">
                ...
                criteria. Try modifying your filters or resetting them.
              </p>
              <button
                onClick={handleResetFilters}
                className="bg-primary-teal text-white text-xs font-semibold px-5 py-2.5 rounded-btn hover:bg-primary-teal-dk transition-colors"
              >
                Clear All Filters
              </button>
            </div>
