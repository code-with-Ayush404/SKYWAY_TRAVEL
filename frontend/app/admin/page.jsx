  ...
  const handleEdit = (item) => {
    ...
    if (activeTab === "tours") {
      setFormData({
        ...
        ...item,
        tagsText: Array.isArray(item.tags) ? item.tags.join(", ") : "",
        inclusionsText: Array.isArray(item.inclusions)
          ? item.inclusions.join(", ")
          : "",
        exclusionsText: Array.isArray(item.exclusions)
...
outStation:
  activeTab === "wedding"
    ...
    : formData.outStation,
        ...
        if (editingId) {
          await axios.put(
            `${API_URL}/admin/vehicles/${editingId}`,
            payload,
            authConfig(),
          );
        } else {
...
/>
                ...
                <input
                  required
                  placeholder="Group Size e.g. 2-10 People"
      ...
      >
        Remove Day
              ...
              <>
                <input
                  required
                  placeholder="Vehicle Name e.g. Swift Desire"
                  value={formData.name || ""}
                  onChange={(e) =>
