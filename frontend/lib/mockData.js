...
export const mockTaxis = [
  ...
  },
  {
    ...
    dailyLimitKm: 250,
    image:
      "https://images.unsplash.com/photo-1532581291347-9c39cf10a73c?q=80&w=400",
    capacity: 12,
    luggage: 10,
    transmission: "Manual",
    fuelType: "Diesel",
...
export const mockWeddingCars = [
  {
    ...
    features: [
      "White Silk Flowers decoration",
      "Chauffeur in uniform",
      "Red carpet rollout",
      "Mineral water & tissues",
      "LED custom wedding board",
    ],
    isFeatured: true,
  },
  {
    ...
    features: [
      ...
      "Premium sound system for bride & groom",
      "Red carpet rollout",
    ],
    isFeatured: true,
  },
  ...
  },
  {
    ...
    features: [
      "Premium fresh carnation decoration",
      "Driver in suit & tie",
      "Mini champagne box (non-alc)",
      "Custom groom plate",
    ],
    isFeatured: true,
  },
  ...
  },
  {
    ...
    floralPackagePrice: 4500,
    features: [
      "Authentic vintage horn",
      "Classic white theme ribbons",
      "Retro-styled driver",
      "Vintage photo session ready",
    ],
    isFeatured: false,
  },
  {
    ...
    features: [
      "Open-roof drive option",
      "Sports exhaust note",
      "Minimalist satin bows decoration",
      "Groom self-drive option (deposit req)",
    ],
    isFeatured: false,
  },
  {
    ...
    features: [
      "Front bonnet orchid arrangement",
      "High presence road convoy lead",
      "Spacious cabin for heavy bridal outfits",
    ],
    isFeatured: false,
  },
  {
    ...
    floralPackagePrice: 4500,
    features: [
      "Panoramic roof sunset photos",
      "Air-suspension smooth drive",
      "Premium floral wrap",
      "Exclusive bride assistant helper",
    ],
    isFeatured: false,
  },
  {
    ...
    features: [
      "Quirky red retro layout",
      "White flower wreath decoration",
      "Cute wedding getaway photos",
      "Vintage suitcase boot decor",
    ],
    isFeatured: false,
  },
  {
    ...
    floralPackagePrice: 3000,
    features: [
      "Aggressive road presence",
      "VIP security guard chauffeur",
      "Satin black ribbon trim",
  ...
  },
  {
    ...
    floralPackagePrice: 2000,
    features: [
      "Open top entry for groom",
      "Marigold and rose garland decoration",
      "Off-road terrain reach",
    ],
    isFeatured: false,
  },
  {
    ...
    features: [
      "Red roadster convertible layout",
      "Minimalist tail ribbons",
      "Perfect getaway sportscar",
    ],
    isFeatured: false,
  },
  {
    ...
    features: [
      "Satin ribbons & balloon design",
      "Spacious family commute",
      "Experienced driver",
    ],
    isFeatured: false,
  },
  {
    ...
    features: [
      ...
      "Fairy-tale floral strings",
      "Slow driving nostalgic trip",
    ],
    isFeatured: false,
  },
];
